...
00060	'Rader märkta med &&&&& använder
...
01503	IF S(25)>2 AND S(25)<8 THEN PRINT "Du är i Ateljen." \
GOTO 1511
...
01532	PRINT "TIPS!! Prova orden och gå tillbaka hit." \ S(2)=S(2)-10 \
GOTO 1500
01538	PRINT "TIPS!! Ta lagerkransen och skriv HJÄLP igen."
01539	S(2)=S(2)-10 \ GOTO 1500
01540	IF A(1)<>1 THEN 9991
01542	PRINT "Dörren har gått i baklås så du kommer inte ut åt det
hållet!"
...
02020	PRINT "Du är i en grotta som sträcker sej utom synhåll åt vänster och
höger."
...
02046	PRINT "En liten faun springer fram och tänker trampa dej på
foten"
...
02076	PRINT "Du är på stranden till en underjordisk sjö bredvid en enorm
spelautomat."
02077	PRINT "På den står det: 'DRA I SPAKEN OM DU HAR EN FAUNSKO ATT
SATSA'"
02078	GOSUB 20500
...
02096	GOTO 2087
02101	PRINT "Du fastnade i en jättesugkopp och kan inte komma
loss.";FNS$("sover",15)
...
02120	GOSUB 11000
02121	GOTO 2115
02123	PRINT "Du hoppar ner i brunnen och ramlar tillslut ner på
marken."
02124	GOTO 14000
02126	GOSUB 11000
...
02147	PRINT "En hord fauner kommer framrusande. Nnnnnu är du en våt
fläck."
02148	GOTO 9461
02149	GOSUB 11000
...
02158	S(31)=1
02159	PRINT "Du har blivit nervös och tar fram brännvinsflaskan och dricker
ur den."
02160	GOTO 2150
02161	PRINT "Du har kommit till en sjö där du ser två båtar."
02162	PRINT "Du kliver i en men upptäcker att den bara var en
synvilla."
02163	GOTO 2104
...
02169	GOTO 2150
02173	S(32)=1
02174	PRINT "Du råkar hälla ut vattnet på en faun som springer ylande
iväg."
02175	GOTO 2150
02180	D=INT (RND*10)+1
02181	IF D>8 THEN 2183
02182	GOTO 14100
02183	PRINT "Plötsligt känner du en trasa framför näsan och du säckar
ihop."
...
A$="N" THEN 2204
02222	IF S(35)=1 AND (INSTR(1,A$,"BÅT")>0 OR A$="RO")
THEN 9390
02224	GOTO 2199
...
06002	IF S(2)=335 AND RND>0.5 THEN PRINT "Plötsligt kommer Thorvald fram
och säjer:" \ GOTO 99160
...
06027	IF J(Z)=1 AND A(25)=Z THEN PRINT "En telefon är inkopplad i en jack i
väggen."
06028	IF J(Z)=1 AND A(25)<>Z AND A(30)<>Z THEN PRINT "Det finns
en telefonjack i väggen."
...
06034	IF A(11)=Z THEN PRINT "Det finns ett glittrande pärlhalsband
här."
...
06040	IF J(Z)=1 AND A(30)=Z THEN PRINT "En förlängningssladd är inkopplad i
en jack i väggen."
06042	IF J(Z)<>1 AND A(30)=Z THEN PRINT "Det ligger en
förlängningssladd här."
06043	IF J(Z)<>1 AND S(44)=Z AND A(25)=Z THEN PRINT "En telefon är
inkopplad i en förlängningssladd."
06044	IF S(44)=Z AND (A(25)<>Z OR J(Z)=1) THEN PRINT "En
förlängningssladd sticker in hit."
06048	IF S(44)=-1 AND Z<>A(30) THEN S(44)=Z \ PRINT
"Förlängningssladden räcker precis hit."
...
06070	IF S(48)>0 THEN PRINT "En glasmästare springer förbi
dej."\S(48)=0
06072	IF S(15)<>1 AND S(17)<>1 AND S(18)<>1 THEN 6076
06074	PRINT "En verkmästare från Stugas gatukontor lunkar förbi dej."
\ S(15)=S(17)=S(18)=0
06076	IF S(41)=1 THEN PRINT "En hissreparatör går förbi
...
06108	IF S(6)=2 THEN PRINT "Det finns blodfläckar på golvet." \
RETURN
...
06122	IF S(50)-S(51)<31 AND S(51)>0 THEN PRINT "Du följs av en full
vakt." \ GOTO 6112
06123	S(1)=S(1)-1
...
06132	GOTO 6100
06200	IF A(19)>0 AND A(11)>0 THEN PRINT "Här sitter en gubbe." \
GOTO 6210
...
06206	IF A(19)=0 AND A(10)=0 THEN PRINT "På huvudet bär han din
lagerkrans."
06208	IF A(19)=0 AND A(10)=1 THEN PRINT "Han stirrar på din
lagerkrans."
...
06311	IF FNL$(C$,5)="GRAVS" AND Z=61 THEN PRINT "Gravstenen väger
alldeles för mycket."\GOTO 12210
06312	IF FNL$(C$,5)="KISTA" THEN 6350
06313	IF (FNL$(C$,5)="FAMIL" OR FNL$(C$,5)="VAPEN") AND Z=81
THEN PRINT "Vapnet sitter för hårt fast."\GOTO 12210
...
sitter fast i väggen."\GOTO 12210
06318	IF FNL$(C$,4)="JACK" AND J(Z)=1 THEN PRINT "Jacken sitter
fastskruvad i väggen!"\GOTO 12210
06319	IF FNL$(C$,5)="BRUNN" AND Z=99 THEN PRINT "Brunnen är
gjuten i marken!"\GOTO 12210
06320	IF FNL$(C$,5)="KASSA" AND Z=30 THEN PRINT "Det är
...
06323	IF FNL$(C$,4)="LÅDA" AND A(28)=2 AND Z=56 THEN PRINT "Lådan
är för tung!"\GOTO 12210
06324	IF FNL$(C$,5)="RUBIN" AND A1=1 AND Z=70 THEN 6355
06325	IF FNL$(C$,3)="ASK" AND A(27)=2 AND Z=57 THEN PRINT "Asken
sitter fast i väggen."\GOTO 12210
06326	IF FNL$(C$,5)="FÖNST" AND Z=16 AND A(15)=0 THEN PRINT
"Fönstret är fastkittat i väggen."\GOTO 12210
...
GOTO 12210
06340	IF S(32)=0 THEN PRINT "Din vattenflaska är redan full." \ GOTO
12210
...
06350	IF Z=15 THEN PRINT "Kistan väger 300 kilogram!" ELSE PRINT
"Jag ser ingen KISTA här."
06352	GOTO 12210
06355	PRINT "Just när du ska ta rubinen kommer Thorvald fram och
utropar"
...
06370	PRINT "Du måste skriva vilket slags flaska du menar, t ex TA
SAFTFLASKA."
06372	GOTO 12210
...
06412	IF A(I)=1 THEN PRINT "Du bär redan ";A$(I,4);"." \
GOTO 12210
06414	IF A(I)=5 THEN PRINT "Man kan inte ta tillbaka saker från
maskinen."\GOTO 12210
06418	PRINT "Jag ser ";FNA$(I);A$(I,1);" här." \ GOTO 12210
06420	IF S(1)=9 THEN PRINT "Du kan inte bära fler saker." \ GOTO
12210
...
06525	IF I>0 THEN PRINT "." \ PRINT "Du kan inte bära
resten."
06530	GOTO 12210
...
här." \ GOTO 6560
06555	IF I=0 THEN PRINT "Det finns inget som du kan ta här." ELSE
PRINT "."
06560	GOTO 12210
07000	REM XXXXX SLÄPP XXXXX
07001	IF C$="" THEN C$=FNI$("Släpp vadå ?") \
A$=C$=FNC$(C$)
...
07043	IF Z=4 THEN PRINT "En mystisk kraft hindrar dej från att släppa
någonting här." \ GOTO 12210
...
07052	IF I=22 AND Z=63 THEN PRINT "Du lägger försiktigt ner liket."
ELSE PRINT "Ok."
07054	GOTO 12210
...
07080	PRINT "Just som du ska koppla in telefonen kommer en man klädd i en
röd"
07081	PRINT "dräkt som det står 'TELE' på, ";
07082	IF J(Z)=1 THEN PRINT "skruvar bort telefonjacken" \ J(Z)=0
07083	IF J(Z)<>1 THEN PRINT "tar bort förlängningssladden" \
S(44)=0 \ A(30)=0
07084	PRINT "och sluddrar fram:"
07085	PRINT "- Abonnemangsavgiften är inte betald." \ PRINT
07087	X1=1 \ GOSUB 27050
07088	GOTO 12999
07090	IF I=19 THEN PRINT "Gubben tar snabbt vattenflaskan när du släpper
den." \ GOTO 7094
07092	PRINT "Gubben sätter din lagerkrans på sitt huvud och ser genast
gladare ut."
...
08097	IF S(48)>0 THEN PRINT "Det finns ett krossat fönster här." \
GOTO 8102
...
08108	PRINT "Inget du bär kan hjälpa dej att komma upp till fönstret."
\ S(2)=S(2)-2
08110	GOTO 8095
08112	ON S(45) GOTO 8250,8254,8253
08131	PRINT "Du sparkar din boll mot fönstret."
08132	PRINT "   PANG!"
08133	PRINT "Fönsterrutan gick sönder." \ IF S(48)=-1 THEN
S(2)=S(2)+10\S(48)=0
08134	S(48)=S(48)+1
08135	PRINT "Ett rep ramlar ner genom fönstret och nån viskar: -Kom
fort!"
...
08148	IF S(48)<>-1 THEN PRINT "Du är i en mörk gång." ELSE GOSUB
730 \ GOTO 17000
...
08290	PRINT "Du kan gå åt vänster,höger,framåt,bakåt,uppåt och
neråt!"
08291	RETURN
...
08377	PRINT "Din trilogi (Sagorna om Härskarringen) försvinner
plötsligt."
...
08443	PRINT " - Om du säjer ett niosiffrigt tal där ingen siffra är över
fem"
08444	PRINT "så ska jag, Fozzi den rolige, hjälpa Dej med en
berättelse."
...
08460	PRINT
08463	PRINT "Fozzi skriver upp en berättelse på en lapp som han ger
dej."
08465	PRINT "Du går tillbaka till scenen och berättar."
08470	PRINT
08472	PRINT " - Ett meddelande når ";FNF$(1);" att
";FNF$(2)
08475	PRINT "  har släppts ut ur ";FNF$(3);" och kommer för att
lägga"
08480	PRINT "  beslag på ";FNF$(4);". Staden befinner sej snart i
klorna på"
08485	PRINT "  ";FNF$(5);" och folket sätter sej ner och väntar
på "
08487	PRINT "  ";FNF$(6);"."
08490	PRINT "  Oroliga för att skurkarna tänker ";FNF$(7);"
börjar"
08495	PRINT "  saloonflickorna bli ";FNF$(8);". Skurkarna
kommer"
08500	PRINT "  men faran avvärjs ";FNF$(9);"."
08532	PRINT\PRINT "Publiken jublar men gubbarna på balkongen är bara
spydiga."
08533	GOTO 8907
08600	S(36)=1 'XXX VÄDERSTRECKSSUBRUTIN XXXXX
08602	IF A$="" THEN 12210
08603	X=0 \ X1=0 \ A$=FNC$(A$)
08604	IF FNL$(A$,6)="SYDOST" OR FNL$(A$,6)="SYDÖST" OR
A$="SO" OR A$="SÖ" THEN X=8
08605	IF FNL$(A$,4)="VÄST" OR A$="V" THEN X=1
08606	IF FNL$(A$,3)="ÖST" OR FNL$(A$,3)="OST" OR
A$="Ö" OR A$="O" THEN X=2
08607	IF FNL$(A$,4)="NORR" OR FNL$(A$,4)="NORD" OR
A$="N" THEN X=3
08608	IF FNL$(A$,3)="SYD" OR FNL$(A$,5)="SÖDER" OR
A$="S" THEN X=4
08609	IF FNL$(A$,5)="NORDV" OR A$="NV" THEN X=5
08610	IF FNL$(A$,4)="SYDV" OR A$="SV" THEN X=6
08611	IF FNL$(A$,5)="NORDO" OR FNL$(A$,5)="NORDÖ" OR
A$="NO" OR A$="NÖ" THEN X=9
08612	GOTO 12025
...
08650	IF A(8)=1 THEN PRINT "en läsvärd trilogi (Sagorna om
Härskarringen)"
...
08663	GOTO 12210
08700	PRINT "Du kan inte få nå'n hjälp så som du ser ut!"\
D=INT(RND*5)+1
...
08871	GOTO 8833
08873	PRINT "Kermit frågar dej om du vill sjunga eller berätta en
historia."
...
08882	PRINT "läktaren skrattar (åt ditt utseende). Fozzi erbjuder dej
hjälp."
...
08904	PRINT "Wayne & Wanda kommer bakifrån och kastar upp dej i
luften!"
...
08913	PRINT "Du får ett skärt kontrakt av Kermit."\PRINT "Det
finns en dörr till höger."
08914	A(9)=1 \ S(1)=S(1)+1
08915	A$=FNI$("Svara FÖLJ (Fozzi) eller HÖGER :") \ A$=FNC$(A$) \
PRINT
...
08928	PRINT "Fozzi tackar för sej och går. Det finns en dörr till
vänster."
08929	A$=FNI$("Svara FÖLJ (Fozzi) eller VÄNSTER :") \ A$=FNC$(A$) \
PRINT
08930	IF FNL$(A$,5)="VÄNST" THEN 8950
08931	IF FNL$(A$,4)="FÖLJ" THEN 8943
08932	GOTO 8929
08943	PRINT "Nu går Fozzi in genom en dörr. Det finns också en dörr
framåt."
08944	A$=FNI$("Svara FÖLJ (Fozzi) eller FRAMÅT :") \ A$=FNC$(A$) \
PRINT
...
08970	PRINT "Du är inne i en tortyrkammare. Dörren gick i lås bakom
dej!"
08971	PRINT "Väggarna närmar sej. Enda vägen ut spärras av ett
monster!"
...
08984	PRINT "intellektuella nivå. Vi ska idag prata kring ämnet
";W$(2);"."
08985	PRINT W$(6);" får inleda med en replik. Vad tycker du om
";W$(2);"?"
08987	A$=FNI$("")
...
08994	PRINT "Kermit: Öh...Vi får visst avrunda här. Nästa veckas
ämne:"
...
09037	PRINT "Du befinner dej i andra våningens hissrum. Till höger ser
man"
09039	IF S(40)=2 THEN PRINT "en öppen"; ELSE PRINT "en
stängd";
...
THEN 9233
09240	GOTO 9224
09250	PRINT "Du är i ";R$;" våningens hissrum. Till vänster finns
en"
09252	IF S(40)=Z-20 THEN PRINT "öppen"; ELSE PRINT
"stängd";
...
X%=1 \ GOTO 9280
09268	IF S(40)=10 THEN PRINT "Hissen kommer inte. Den måste vara
...
09304	IF S(22)/2=INT(S(22)/2) THEN PRINT "Du är i hissen." \ GOTO
9307
09305	PRINT "Du är i hissen. Här finns tio knappar. Dom nio första är
numrerade"
...
09359	PRINT "Hissen är framme. Du går ur..."\ IF RND<0.1 THEN
S(41)=1
...
09366	GOSUB 15200
09368	IF S(35)=0 AND (INSTR(1,A$,"BÅT")>0 OR A$="RO")
THEN 9390
...
09426	PRINT "Ett staket hindrar dej att gå åt NORDOST,ÖSTER eller
SYDOST."
09428	GOSUB 15200
...
09433	GOTO 9424
09436	IF INSTR(1,A$,"BADHYTT")>0 OR FNL$(A$,5)="ÖPPNA" OR
A$="IN" THEN 9439
09437	GOSUB 11000
09438	GOTO 9424
09439	PRINT "Du går in i badhytten men golvet ger vika och du
faller..."
09440	GOTO 25000
...
09493	IF S(47)>0 THEN PRINT "Det finns ett hål till vänster." \
GOTO 9496
...
09511	IF S(47)>0 THEN PRINT "Det finns ett hål i väggen." ELSE
PRINT "Du är vid draperiet."
09512	GOSUB 12200
09515	IF X=5 THEN 9525
09516	IF X=6 THEN 9492
09517	IF FNL$(A$,5)="KLIPP" AND S(47)=0 THEN 9520
09518	IF (FNL$(A$,5)="ÖPPNA" OR FNL$(A$,3)="DRA") AND
S(47)=0 THEN 9523
...
09534	PRINT "Ok." \ PRINT "Du går genom en dörröppning." \
GOTO 8950
...
09547	IF A(28)=2 THEN PRINT "Det ligger en låst låda här som du inte orkar
bära."
09548	GOSUB 12200
...
inte." \ GOTO 9545
09554	PRINT "Du låser upp lådan och hittar en slägga. Lådan
försvinner."
...
09562	IF A(27)=2 THEN PRINT "Fastskruvad i väggen sitter en glasask med en
sax i."
09563	GOSUB 12200
...
09569	IF A(28)<>1 THEN PRINT "Du har inget att slå med."\ GOTO
9558
09570	PRINT "Du krossar glaset. Saxen ramlar ur och asken försvinner i ett
moln."
...
09578	GOTO 9461
09950	IF M2%=1% THEN CLOSE 2 \ M2%=0%'&&&&& Stäng ev.
loggfil
...
10008	GOTO 9997
10009	PRINT "Du är i en hall med tre dörrar. På den vänstra finns en
nedåtriktad"
10010	PRINT "pil, på dörren rakt fram finns en pil som pekar uppåt och på
dörren"
10011	PRINT "till höger står det atelje. Bakom dej ligger porten ut ur
huset."
10012	IF S(19)=1 THEN PRINT "Ytterporten är öppen."
10013	IF S(8)>7 THEN S(8)=3
10014	GOTO 10001
10015	IF S(19)=1 THEN PRINT "Porten stängs bakom dej."\S(19)=0\GOTO
20200
10016	PRINT "Porten är stängd!"
10017	GOTO 10000
10020	Z=16'XXXXX SKUMGUMMIRUMMET XXXXX
10022	PRINT "Du är i Skumgummirummet."
10024	IF A(15)=0 THEN PRINT "Det finns ett mystiskt, mörkt fönster i
väggen."
...
10046	IF FNL$(A$,5)="ÖPPNA" THEN PRINT "Du kan inte öppna
fönstret." \ GOTO 10052
10050	GOSUB 11000
...
10068	IF A$="NEJ" THEN PRINT "Det var ju skönt!" \ GOTO
10052
10070	IF FNL$(A$,5)<>"DIAMA" THEN PRINT "Det går
inte!" \ GOTO 10052
10072	IF A(1)<>1 THEN PRINT "Du bär väl ingen DIAMANT!"\GOTO
10052
...
10079	S(2)=S(2)+10\PRINT "När du vaknar är du fortfarande i
Skumgummirummet."
10080	A(15)=16 \ GOTO 10030
10084	IF A(28)<>1 THEN PRINT "Du har inget att slå med." \ GOTO
10052
10086	PRINT "Du krossar fönstret med släggan. Därbakom finns en
kofot."
10087	PRINT "Thorvald springer fram och säjer: - Jag hörde braket! Nu tar
jag"
...
10092	IF A(1)<>1 THEN PRINT "Försök att hitta något du kan skära upp
fönstret med."
...
11002	IF INSTR(1,A$,"HJÄLP")>0 THEN PRINT "Du kan inte få
någon hjälp här." \ GOTO 11100
11003	IF A$="N" OR A$="V" THEN PRINT "Du kan inte gå
ditåt." \ GOTO 11100
11004	IF
INSTR(1,"*NORR*SÖDER*VÄSTER*ÖSTER*NV*NÖ*NO*SV*SÖ*SO","*"+A$)>0
THEN 11200
11005	IF
INSTR(1,"*NORDVÄST*NORDÖST*NORDOST*SYDVÄST*SYDÖST*SYDOST","*"+A$)>0
THEN 11200
11006	IF
INSTR(1,"*UPPÅT*NEDÅT*NERÅT*VÄNSTER*HÖGER*FRAMÅT*BAKÅT","*"+A$)>0
THEN 11220
11007	IF INSTR(1,A$,"SESAM")=0 AND INSTR(1,A$,"KORKSKRUV")=0
THEN 11011
11008	PRINT "Ingenting händer."
11009	GOTO 11100
11011	IF INSTR(1,A$,"STÄNG")>0 THEN PRINT "Det finns inget du
kan stänga här!"\GOTO  11100
11013	IF INSTR(1,A$,"KROSS")>0 THEN PRINT "Det finns inget du
kan krossa här!"\GOTO 11100
11014	IF INSTR(1,A$,"SKÄR")>0 THEN PRINT "Det finns inget du
kan skära här!"\  GOTO 11100
11015	IF A$="SE" OR INSTR(1,A$,"TITTA")>0 THEN RETURN
11017	IF FNL$(A$,5)="HOPPA" AND X=1 THEN PRINT "Du kommer
ingenstans uppåt." \ GOTO 11100
11018	IF FNL$(A$,5)="HOPPA" THEN PRINT "Det finns inget hål att
...
11205	GOTO 11100
11220	IF S(36)=1 THEN PRINT "Utomhus ska du ange väderstreck, inte
riktningar."
...
12052	IF FNL$(A$,5)="VÄNTA" OR FNL$(A$,5)="STANN" THEN
12570
12055	IF INSTR(A$,"HELVETE")>0 THEN PRINT "Åt vilket håll är
det?" \ GOTO 12210
...
12061	IF FNL$(A$,3)="FAN" OR FNL$(A$,5)="JÄVLA" OR
FNL$(A$,6)="DJÄVLA" OR FNL$(A$,5)="SATAN" THEN 12555
...
12076	IF A$="POÄNG" THEN PRINT "Du
har";S(2);"poäng." \ GOTO 12210
...
12089	IF FNL$(A$,5)="KASTA" THEN PRINT "Tyvärr har kastarmen gått
ur led."\GOTO 12210
12090	IF FNL$(A$,4)="INFO" THEN 12770
12091	IF FNL$(A$,3)="ÅT" AND C$<>"" THEN A$=C$ \ GOTO
12214
...
12172	IF J(Z)<>1 THEN PRINT "Det finns ingen jack här." \ GOTO
12210
...
12220	IF A(10)=5 OR A(10)=53 THEN PRINT "Ingenting händer." \ GOTO
12210
12223	IF A(10)=1 THEN 12226
12224	IF Z=53 THEN PRINT "Nu hänger lagerkransen på väggen." ELSE
PRINT "Ok."
12225	A(10)=53 \ GOTO 12210
12226	S(1)=S(1)-1 \ A(10)=53
12227	IF Z=53 THEN 12224
12228	PRINT "Lagerkransen försvinner." \ GOTO 12210
12230	IF A(21)<>1 THEN PRINT "Du har ingenting du kan gräva
med." \ GOTO 12210
12232	IF Z<>77 THEN PRINT "Marken är för hård." \ GOTO 12210
12234	IF S(20)=1 THEN PRINT "Platsen är redan helt utgrävd." \ GOTO
12210
...
12320	NEXT I
12322	PRINT \ S(31)=1
12324	PRINT "Nu hoppas jag att vi har nyktrat till så pass att vi kan
fortsätta!"
...
\ GOTO 12210
12366	IF S(31)=1 THEN PRINT "Din brännvinsflaska är tom." \ GOTO
12210
...
12376	S(6)=3 \ A(29)=Z
12378	GOTO 12210
12380	IF A(19)<>1 THEN PRINT "Du bär ingen vattenflaska som du kan
fylla."\GOTO 12210
12382	IF S(32)=0 THEN PRINT "Din vattenflaska är så full den kan bli."
\ GOTO 12210
...
12468	PRINT "Du öppnar garderoben och hittar ett litet kassaskåp
där."
12469	S(23)=1 \ GOTO 12210
12470	IF Z=30 THEN 12480
12472	IF Z=31 THEN 12486
12478	GOTO 12084
12480	IF S(23)=0 THEN PRINT "Garderoben är redan stängd." \ GOTO
12210
...
12510	IF Z<>63 AND Z<>61 THEN PRINT "Marken är för hård!"
\ GOTO 12210
...
levande!" \ GOTO 12210
12516	IF A(22)<>1 AND A(22)<>Z THEN PRINT "Du har inget sånt
...
12576	GOTO 12210
12580	IF S(21)>0 THEN PRINT"Du kan inte sparka något med vrickade
fötter!"\GOTO 12210
...
12592	PRINT "Oj! Du ramlar själv ner i toaletten." \
A$="SPOLA"
12594	GOTO 12999
...
här."\GOTO 12210
12702	PRINT "Tyvärr är kontraktet skrivet med Kermits oläsliga
handstil."
...
12742	PRINT TIME$
12744	GOTO 12210
12750	IF Z<>61 THEN PRINT "Jag ser ingen GRAVSTEN här." \ GOTO
12210
...
12774	PRINT "UPPÅT, NERÅT, FRAMÅT, BAKÅT, VÄNSTER, HÖGER (U, N, F, B, V,
H)"
...
12800	IF A(25)=1 AND (J(Z)=1 OR S(44)=Z) THEN PRINT "Du HÅLLER ju i
telefonsladden."
...
12830	GOTO 12210
12835	IF W$(6)="" THEN PRINT "Du hör din egen röst:  - Jag är
inte hemma än!" \ GOTO 12210
12836	PRINT "Du hör en röst säja:"
12837	PRINT "- Detta är "W$(6)"s telefonsvarare.
"W$(6)" är inte hemma."
12838	GOTO 12210
12840	IF S(30)<>Z THEN PRINT "Du kan inte ge något till någon
här."\ GOTO 12210
12842	IF I=10 OR I=19 THEN 7030
12844	IF INSTR(1,C$,"VATTE")>0 THEN 30010
12846	PRINT "Gubben tar inte emot det." \ GOTO 12210
12850	IF A(24)<>1 THEN PRINT "Du har inget att blända med." \
GOTO 12210
...
12860	IF S(30)<>Z THEN PRINT "Jag ser ingen GUBBE här." \ GOTO
12210
12864	IF A(19)=0 THEN PRINT "Du försöker blända gubben men han
häller"
12866	IF A(19)=0 THEN PRINT "vattenflaskan som skydd." \ GOTO 12210
12868	IF S(49)=0 OR S(49)=2 OR S(30)=96 THEN 30002
12870	S(49)=2 \ PRINT "Du bländar den stackars gubben med lampan." \
GOTO 12210
12880	IF (A(29)=Z OR A(29)=1) AND S(6)<>2 THEN PRINT "Du klarar inte
av att blända vakten."\GOTO 12210
12881	IF S(6)=2 THEN PRINT "Vakten är död." ELSE PRINT "Jag ser
ingen VAKT här."
12882	GOTO 12210
...
12999
12893	IF Z=91 THEN PRINT "Vattenfallets vatten är alldeles för
kallt."\GOTO 12210
...
12908	GOTO 12210
12910	IF INSTR(1,A$,"RÖVAR")>0 THEN PRINT "Jag ser ingen
RÖVARE här." \ GOTO 12210
12912	IF INSTR(1,A$,"GUBBE")>0 THEN 12920
12914	IF INSTR(1,A$,"EFTER")>0 THEN PRINT "Jag ser ingen du
kan följa efter."\GOTO 12210
12916	IF (INSTR(1,A$,"RÅD")>0 OR
...
12924	PRINT "Du ska inte ha någon fördel bara för att Stugrådet råkar ha
samman-"
12926	PRINT "träde när du ramlar in. Du får försöka hitta skattkammaren
själv."
...
12958	PRINT "Nu loggas alla kommandon på filen
";M2$'&&&&&
...
13196	IF A(26)<>2 THEN PRINT "Vakten orkar låsa upp porten, men han
har inga nycklar."
...
13202	IF A(26)=1 THEN PRINT "Du orkar inte vrida om nyckeln själv." \
GOTO 13173
13204	IF A(29)<>1 OR A(26)<>2 THEN PRINT "Det går inte." \
GOTO 13173
13206	PRINT "Vakten låser upp porten."
13208	PRINT "Han tittar på nycklarna ett slag, innan han äter upp
dom."
13218	S(7)=1 \ A(26)=0 \ S(2)=S(2)+10 \ GOTO 13173
13220	IF S(26)=1 THEN 13235 ELSE S(26)=1
13222	PRINT "Du har kommit in i matrummet. Här har Stugrådet
sammanträde."
13223	PRINT "Just nu pratar ordföranden, Thorvald:"
13224	GOSUB 700
13225	PRINT " - Vi har samlats till detta krismöte för att diskutera
den"
13226	PRINT "   allvarliga frågan om stugforskarnas kvalitet. Jag, och
många"
13227	PRINT "   med mej, anser att stugforskarnas kvalitet genomgående
har"
13228	PRINT "   försämrats."
13229	PRINT "Kimmo:"
13230	PRINT " - Jag håller med dej. Titta bara på den som kom in nu!
Jag"
13231	PRINT "   föreslår att vi fortsätter vårt sammanträde i
skattkammaren."
13232	PRINT \ PRINT "Hela församlingen reser sej och ger sej iväg."
13233	PRINT \ PRINT
13235	Z=59 \ PRINT "Du är i husets matrum. Väggarna är målade i rött och
guld."
13237	IF S(15)=0 THEN PRINT "En trappa leder uppåt."
13238	IF S(15)=1 THEN PRINT "En trappa har gått uppåt, men är nu
obrukbar."
13241	GOSUB 12200
...
14008	PRINT "Till vänster skymtar man en grind och till höger en
panna."
14010	PRINT "Det finns ett hål i golvet och en gång går snett
bakåt-uppåt."
14012	GOSUB 12200
...
14106	PRINT "Du är i Pannrummet, en trång gång går snett
uppåt-framåt"
14107	PRINT "och en går åt vänster. Till höger fortsätter
Pannrummet."
14112	GOSUB 12200
14121	IF X=0 THEN 14099
14124	ON X GOTO 14139,14099,15050,2008,14139,14099,14099
14139	IF A(1)<>1 THEN 14000
14142	PRINT "Nå'nting du bär på tar emot. Skriv INVENT och släpp
det."
14145	GOTO 14100
14998	GOSUB 11000
...
15302	PRINT "Du är i Hilbertrummet, ett rum med fyra dörrar och hål i taket
och golvet."
15304	IF A(17)=11 THEN PRINT "En stege är uppställd mot hålet i
taket."
15306	GOSUB 12200
...
15354	IF S(17)=1 THEN PRINT "Den nedåtgående rulltrappan är avspärrad av
Stugas gatukontor."
15355	IF S(18)=1 THEN PRINT "Den uppåtgående rulltrappan är avspärrad av
Stugas satukontor."
15356	GOSUB 12200
...
15372	PRINT "Du är i ett rum med en nedåtgående rulltrappa och en dörr åt
höger."
15373	IF S(18)=1 THEN PRINT "Rulltrappan är avspärrad av Stugas
gatukontor."
15374	GOSUB 12200
15375	IF X=4 THEN 9035
15376	IF A(1)=1 AND X=2 AND S(18)=0 THEN 15382
15377	IF X=2 AND S(18)=0 THEN 15350 ELSE 15369
15382	PRINT "Just när du går fram mot rulltrappan, stannar den och
en"
15383	PRINT "gubbe springer fram och spärrar av den."
15384	S(18)=1 \ GOTO 15370
15385	GOSUB 11000
15386	Z=48'XXX TRAPPRUM 3 XXXXX
15388	PRINT "Du är i ett rum med en uppåtgående rulltrappa och en dörr
framåt."
15390	IF S(17)=1 THEN PRINT "Rulltrappan är avspärrad av Stugas
gatukontor."
15392	GOSUB 12200
15394	IF X=5 THEN 15050
15396	IF X<>1 OR S(17)<>0 THEN 15385 ELSE IF A(1)<>1 THEN
15350
15398	PRINT "Just när du går fram mot rulltrappan, stannar den och
en"
...
låset!"
15437	GOTO 15432
15438	IF A(1)=1 THEN PRINT "TIPS!! Något du bär hindrar dej att gå
bakåt!" \ GOTO 15432
15439	GOTO 15431
16000	Z=12 \ S(12)=S(12)+1'XXXXX VINDEN XXXXX
16012	IF S(12)>2 AND S(12)<8 THEN PRINT "Du är på vinden." \
GOTO 16055
...
16040	IF RND<0.5 THEN PRINT "Någon säjer:  - Du kom hit klockan
";W$(3);" ";W$(4)
...
16512	IF S(13)>2 AND S(13)<8 THEN PRINT "Du är i Tomma rummet."
\ GOTO 16530
16515	PRINT "Du är i ett tomt rum. Det finns ett hål i taket och en
ribbstol"
...
17032	GOSUB 11000
17033	GOTO 17010
17100	PRINT "Du är i ett underligt rum. Dimslöjor sveper kring dina
fötter"
...
17182	PRINT "Du har vindlat runt i en trång gång och kommer
tillbaka."
17183	GOTO 17010
17185	D=INT(RND*6)+1
...
17250	GOTO 17182
18000	PRINT "Du är i ZZZZ-rummet. Ett stort schackbräde är ritat på
golvet."
...
18081	PRINT "- Det är väl synd att gå omkring här med en tom
brännvinsflaska."
18090	PRINT \ PRINT "Han tar fram en fickplunta ur kostymen och fyller
på"
18095	S(31)=0
18100	PRINT "din brännvinsflaska."
18105	PRINT "Fozzi mumlar något om en faun och knuffar ut dej ur
rummet."
...
20001	PRINT "Du står på en brygga någonstans i Småland. Bakom din solvärmda
rygg"
20002	PRINT "åker man vattenskidor. En kyrkklocka (som du inte ser) slår
tolv."
...
20043	GOSUB 15200
20044	IF A$="IN" THEN PRINT "Grinden är ju låst!"\GOTO
20040
20045	IF FNL$(A$,3)="LÅS" THEN IF A(26)=1 THEN 20042 ELSE PRINT
"Det går inte!"\GOTO 20040
...
20061	PRINT "Du är på en strand som fortsätter åt öster. Långt bort i
öster"
20062	PRINT "skymtar man en brygga. Åt norr och söder är det skog."
20063	PRINT "Ett staket hindrar dej att gå åt väster, nordväst eller
sydväst."
20064	GOTO 20055
...
20093	GOTO 20085
20094	PRINT "Du går runt, runt. Efter ett tag märker du att du gått
vilse."
...
20110	IF S(20)<1 THEN PRINT "Det ser ut som något har grävt här
tidigare."
...
20225	IF S(19)=1 THEN PRINT "Porten stängs bakom dej." \ S(19)=0 \
GOTO 9991
20226	PRINT "Porten är stängd!"
20227	GOTO 20200
20230	PRINT "En avskyvärd stank driver dej tillbaka!"
20231	GOTO 20200
20232	PRINT "Du står på en trappa framför ett stort hus. En stor
port"
...
20356	PRINT " - Hjälp	! Jag vet inte om jag är en bug eller en
feature!"
...
25001	PRINT "Du är i Thorvalds rum. Vid väggen står en stor
förseglad"
25004	IF A(1)=0 THEN A(1)=15
25005	PRINT "kista. I taket finns en taklucka och i golvet finns ett
hål."
25008	IF A(3)=31 THEN PRINT "På väggen står det: KORKSKRUV HJÄLPER TILL MED
KASS..."
25010	GOSUB 12200
...
25020	IF INSTR(1,A$,"LÅS UPP KIST")>0 THEN PRINT "Det finns
inget lås."\GOTO 25025
25023	GOSUB 11000
25025	PRINT "Du är i Thorvalds rum." \ GOTO 25010
25035	IF A(15)<>1 THEN PRINT "Du kan inte öppna
kistan."\GOTO25025
25036	PRINT "Du bänder upp kistan med din kofot och ser att det ligger
en"
25037	PRINT "cykelpump där!"
25038	PRINT "Slarvig som du är lyckas du tappa kofoten i kistan när du
tar"
...
25023
25050	IF A(17)<>1 AND A(17)<>Z THEN PRINT "Takluckan sitter för
högt!"\GOTO 25000
25051	PRINT "Du klättrar upp på stegen och öppnar luckan."
25053	IF A(2)<>0 THEN PRINT "Där finns inget, så du klättrar ner
igen."\ GOTO 25000
...
25062	IF A(17)<>1 AND A(17)<>Z THEN PRINT "Det behövs en stege
för att nå upp."
...
säjer:"
25104	PRINT "-Vad har du här att göra? Räcker det inte med att folk
ränner"
...
25119	GOSUB 7500
25120	GOTO 9461
25121	PRINT "Den missar!" \ PRINT "Golvet ger plötsligt vika och
du faller."
25122	GOTO 15300
...
27080	J(D)=1
27085	RETURN
27100	PRINT "Just när du ska koppla in telefonen kommer en man med en
röd"
27110	PRINT "dräkt som det står TELE på in och slänger en
telefonkatalog"
27120	PRINT "på dina fötter."
27122	IF J(Z)<>1 THEN 27140 ELSE J(Z)=0
27130	PRINT "Med en sur min skruvar han bort telefonjacken ur väggen och
går."
27140	S(2)=S(2)+5
...
27440	PRINT "Vänta, var det hissen du sa ?  Jag får väl se över den
då."
...
27614	IF Z=100 THEN PRINT "Det är visst upptaget." ELSE PRINT
"Ingen svarar."
27616	GOTO 12210
27620	PRINT "En automatisk telefonsvarare svarar:"
27622	PRINT " - Han är tyvärr inte inne. Han har alltid så mycket
att"
...
27633	IF Z=58 THEN PRINT "Du hör en signal. Vakten går bort ett
ögonblick."
27634	PRINT "Ring, Ring	!"
27636	PRINT " - Stör mej inte! Jag vaktar!"
27638	GOTO 27626
27640	IF (A(29)=58 OR A(29)=1) AND Z=58 THEN PRINT "Du hör en signal.
Vakten kravlar iväg."
...
28002	IF A(29)=Z OR A(29)=1 THEN PRINT "Vakten sover för djupt." \
GOTO 12210
28010	IF A(29)<>Z AND A(29)<>1 THEN PRINT "Jag ser ingen VAKT
här."\GOTO 12210
28012	IF S(6)=2 THEN PRINT "Vakten är redan död! Ser du inte
blodfläckarna!"\GOTO 12210
28014	IF A(4)<>1 THEN PRINT "Du har inget du kan döda honom
med."\GOTO 12210
...
I<>18 THEN 28108
28112	IF A(I)<>1 THEN PRINT "Du bär väl
...
29095	PRINT
29100	PRINT "Plötsligt hoppar en skäggig rövare fram ur mörkret och
säjer:"
...
30010	IF S(30)<>Z THEN PRINT "Jag ser ingen gubbe här." \ GOTO
12210
...
30042	GOTO 30002
30050	IF S(30)<>Z THEN PRINT "Jag ser ingen GUBBE här." \ GOTO
12210
...
35120	PRINT "Hej, ";W$(6);" ! Bra att Du också har skaffat en
telefon."
35122	PRINT "<klick>"
35125	GOTO 35030
35150	IF A(1)=1 THEN PRINT "Dörren är igenbommad av Stugas
gatukontor." \ GOTO 35000
35155	GOTO 2127
36000	Z=61'XXXXX KYRKOGÅRD XXXXX
36005	PRINT "Du är på en kyrkogård. Du står vid en gravsten på
kanten"
...
40030	PRINT "Du är i Osvalds rum, ett rum med fyra dörrar. På den högra
står det"
40031	PRINT "ZZZZ, på den vänstra står det THORVALD och på den rakt
fram"
...
40145	IF S(15)<>0 THEN PRINT "Trappan är avspärrad av Stugas
...
41120	GOTO 41040
80000	REM *** SPARA *** &&&&& DEC-10 SPECIELL KOD PÅ
80000-80565
...
80150	CLOSE 1'&&&&&
80155	PRINT "Det nuvarande läget är sparat på filen
STUGA.SPA."'&&&&&
80160	GOTO 12210'&&&&&
80200	REM *** ÅTERSKAPA ***'&&&&&
...
80318	INPUT #1,S(0)'&&&&&
80319	IF S(0)=0 THEN S(0)=53'$$$$$ Standardvärde. Raden bör tas bort
småningom'&&&&&
80320	INPUT #1,S(I) FOR I=1 TO S(0)'&&&&&
80325	X=X+S(I)/(PI-1) FOR I=0 TO S(0)'&&&&&
80326	IF S(24)=0 THEN S(24)=6'$$$$$'&&&&&
80327	ON ERROR GOTO 80540'$$$$$ Koll om gammal fil. Raden bör tas
bort.'&&&&&
...
80345	IF ABS(X-I1)>0.03 THEN PRINT "Fel på STUGA.SPA!" \
STOP'&&&&&
...
80525	CLOSE 1'&&&&&
80530	RESUME 99999'&&&&&
80540	RESUME 80545'$$$$$ Raderna 80540-80565 bör tas bort
småningom.'&&&&&
...
90054	W$(1)="Stugrådet: Thorvald, Kimmo Eriksson, Olle Johansson, Viggo
...
90308	DATA
"DÖDSKALLE","DÖDSK","SKALL","dödskallen",0
90310	DATA
"KLOCKA","VÄCKA","KLOCK","klockan",59
90312	DATA
"GULDMYNT","GULD","MYNT","guldmynten",0
90314	DATA
"TRILOGI","TRILO","SAGAN","trilogin",36
90316	DATA
"KONTRAKT","KONTR","SKÄRT","kontraktet",0
90318	DATA
"LAGERKRANS","LAGER","KRANS","lagerkransen",53
90320	DATA
"PÄRLHALSBAND","PÄRL","HALSB","pärlhalsbandet",0
90322	DATA
...
90336	DATA
"BRÄNNVINSFLASKA","BRÄNN","BRÄNN","brännvinsflaskan",97
90338	DATA
...
90356	DATA
"SLÄGGA","SLÄGG","SLÄGG","släggan",2
90357	DATA
"VAKT","VAKT","VAKT","vakten",58
90358	DATA
"FÖRLÄNGNINGSSLADD","FÖRLÄ","SLADD","förlängningssladden",26
...
90406	DATA "bröderna Dalton","Sven Olssons
kvintett","bröderna Brothers"
90408	DATA "Kimmo, den gamle fyllbulten,","Curt
Nicolin","Jesse James"
90410	DATA "fängelset","San Franciscos hem för
tankspridda","sin limosin"
90412	DATA "burarna i Bronx Zoo","en labyrint i
Småland","riksdagshuset"
90414	DATA "fritidsorganet GLAD OCH
NAKEN","sheriffen","guldlasten"
90416	DATA "några glada flickor","en aktie i Kuben","en
illaluktande gurka"
90418	DATA "fruktans demoner","ett bankrån","Butch
Cassidys hustru"
90420	DATA "jultomten","en
hjärnskakningsepidemi","kvarterspolisen"
90422	DATA "ett bakhåll","ett fel på Malmös TV
2-sändare","en taxi"
90424	DATA "att toaletten ska bli ledig","att sheriffen ska göra
något","Lucky Luke"
90426	DATA "skjuta sönder stan","störa
indianerna","varsla om lockout"
90428	DATA "väcka guvernören","ta gisslan på Norges
ambassad","dra sej tillbaka"
90430	DATA "rädda","lätt berusade","måna om sitt
utseende","allt färre"
90432	DATA "svårflörtade","sömniga"
90434	DATA "på ett helt annat ställe","för sent","i
grevens tid"
90436	DATA "en liten aning för
...
91005	PRINT "Du ska utforska ett hus och dess omgivningar. Datorn är
dina"
91010	PRINT "ögon och händer. Ge enkla order till datorn, till
exempel:"
91015	PRINT "SLÄPP TAVLAN, GE SAFTFLASKAN, NORR, UPPÅT, VÄNSTER..."
91020	PRINT "Utanför stugan förflyttar du dej med väderstreck som kan
för-"
91025	PRINT "kortas till N, S, V, Ö, NV, NÖ, SÖ och SV. Inne i stugan
används"
91030	PRINT "riktningarna FRAMÅT (F), BAKÅT (B), VÄNSTER (V), HÖGER
(H),"
91035	PRINT "UPPÅT (U) samt NERÅT (N)."
91040	PRINT "I vissa rum kan du få särskild hjälp (det ger poängavdrag) om
du"
91045	PRINT "skriver HJÄLP. INVENT listar alla saker du bär på, POÄNG
skriver"
91050	PRINT "ut hur många poäng du har och TITTA skriver ut den
fullständiga"
91055	PRINT "beskrivningen av rummet. Ge kommandot SLUTA när du är
färdig."
91060	PRINT "Skriv INFO för att få en lista över kommandona."
91065	PRINT
91070	PRINT "Du ska försöka att skaffa så många poäng som möjligt. Poäng
får"
91075	PRINT "du genom att upptäcka nya ställen och ta vara på
värdesaker."
91080	PRINT
91090	RETURN
...
97011	PRINT "? Kan inte öppna STUGA.TXT<11,155>. Ge
kommandot"'%%%%%
...
nybörjare."\GOTO 99200
99104	IF S(2)<55 THEN I=55 \PRINT "Du är en ren amatör inom
stugforskningen."\GOTO 99200
99110	IF S(2)<65 THEN I=65\PRINT "Du är en duktig nybörjare inom
stugforskningen."\GOTO 99200
99112	IF S(2)<90 THEN I=90\PRINT "Du är en erfaren
stugforskare."\GOTO 99200
99114	IF S(2)<120 THEN I=120\PRINT "Du kan kalla dej en
stugfogde."\GOTO 99200
99120	IF S(2)<150 THEN I=150\PRINT "Du är en erfaren stugfogde."\
GOTO 99200
99130	IF S(2)<200 THEN I=200 \ PRINT "Du är en väldigt erfaren
stugfogde."\GOTO 99200
99140	IF S(2)<250 THEN I=250 \ PRINT "Du är biträdande expert på hus i
Småland." \ GOTO 99200
99145	IF S(2)<300 THEN I=300\PRINT "Du är expert på hus i
Småland."\GOTO 99300
99150	IF S(2)<335 THEN I=335 \PRINT "Du är föreslagen som medlem i
stugrådet."\GOTO 99200
99160	PRINT "	GRATTIS !!"
...
99302	INPUT "Vill du ge några synpunkter på STUGA";A$ \
A$=FNC$(A$)'%%%%%
